{{-- <div class="dash-div" >
    <div class="main-box custom-box"> --}}
        ...
        <div class="step-1-form">
            <h2 class="question"><b>{{ $previousQuestion->question }}</b></h2>
            <?php if ($previousQuestion->type == 1 && !empty($previousQuestion->answers)) { ?>
                <div class="selectBoxGroup">
                    {{-- @dd($previousQuestion->answers); --}}
                    <?php foreach (explode(",", $previousQuestion->answers) as $answer) { ?>
            ...
            <?php } else if ($previousQuestion->type == 2 && !empty($previousQuestion->answers)) { ?>
            <div class="selectBoxGroup">
            ...
            <?php } else if ($previousQuestion->type == 3) { ?>
            ...
            <?php } else if ($previousQuestion->type == 4 && !empty($previousQuestion->answers)) { ?>
            <div class="selectBoxGroup">
                <?php foreach (explode(",", $previousQuestion->answers) as $answer) { ?>
                <div class="selectBox radio">
            ...
            <?php } else if ($previousQuestion->type == 5 && !empty($previousQuestion->answers)) {
            $isOther = true; ?>
            <?php if ($previousQuestion->id == 0) { ?>
            <div class="selectBoxGroup">
                <?php foreach (explode(",", $previousQuestion->answers) as $answer) { ?>
                <div class="selectBox radio">
                    <input type="radio" name="answer" id="radio-<?php echo $answer; ?>"
            ...
            <?php }
            if ($previousQuestion->id == 0) {
                if (isset($currentAnswer) && isset($currentAnswer->answers)) {
                    $answers = explode(",", $previousQuestion->answers);
